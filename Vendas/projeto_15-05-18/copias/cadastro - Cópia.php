						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								...
								<div class="form-group">
										<label class="col-md-2 control-label">Seu nome:</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa-user"></i>
											</span>
												<input id="text" class="form-control1" type="text" placeholder="Seu nome">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
										<label class="col-md-2 control-label">Seu Endereço:</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa-home"></i>
											</span>
												<input id="text" class="form-control1" type="text" placeholder="Seu Endereço">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input id="text" class="form-control1" type="text" placeholder="Seu telefone">
										</div>
									</div>
								</div>
								
								<div class="form-group">
										<label class="col-md-2 control-label">Seu email:</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa-envelope"></i>
											</span>
												<input id="email" class="form-control1" type="text" placeholder="Seu email">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input id="text" class="form-control1" type="text" placeholder="Data de Nascimento">
										</div>
									</div>
								</div>
								
								<div class="form-group">
									<label for="selector1" class="col-sm-2 control-label">Sexo</label>
									<div class="col-sm-8">
								...
								<div class="form-group">
									<label for="radio" class="col-sm-2 control-label">Nothing</label>
									<div class="col-sm-8">
