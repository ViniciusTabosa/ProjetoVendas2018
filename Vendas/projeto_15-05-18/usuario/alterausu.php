...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../principal.php">Principal</a><i class="fa fa-angle-right"></i>Usuario <i class="fa fa-angle-right"></i> Busca de Usuarios<i class="fa fa-angle-right"></i>Alteração de Usuario</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">

  <div class="grid-form1">
  	       <center><h3><i class="fa fa-user"></i> Alteração de Usuario </h3></center>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['codUsu']?>" name="codusu" id="codusu" type="text" class="form-control1" readonly="true">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['senha']?>" name="senha" id="senha" type="password" class="form-control1">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['email']?>" name="email" id="email" type="email" class="form-control1">
										</div>
									</div>
								</div>
