...
<script>
   ...
   function alterar(cod){
	   if(confirm('Deseja alterar esse item?')){
		  location.href='alterausu.php?cod='+cod; 
	   }
   }   
</script>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i>Usuario<i class="fa fa-angle-right"></i>Busca de Usuario</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<a href="cadastrousu.php" class="btn btn-md btn-success pull-right"><i class="fa fa-plus"></i>&nbsp;Novo</a></br>
