...
<!--heder end here-->
  ...
  <div class="grid-form1">
  	       ...
  	       <center><h3><i class="fa fa-user"></i> Cadastro de Usuarios </h3></center>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="nome" id="name" type="text" class="form-control1" placeholder="Seu Nome">
										</div>
									</div>
								</div>
								
								<div class="form-group">
										<label class="col-md-2 control-label"> Sua Senha</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
