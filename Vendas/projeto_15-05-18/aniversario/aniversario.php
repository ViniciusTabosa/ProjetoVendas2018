...
<script>
   function niver(cod){
	   if(confirm('Deseja enviar os parabens?')){
		  location.href='p.php?cod='+cod; 
	   }
   }
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i>Cartas de Aniversário<i class="fa fa-angle-right"></i>Busca de Aniversariante</li>
            </ol>
					  ...
					  <form name="f1" method="POST" action="#"><br>	
						...
						?>
						 ...
						 <div class="input-group text-left">
							    <input class="form-control" type="text" name="texto" placeholder="Digite a data do aniversariante">
							...
							if($consulta->num_rows > 0){
							   while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
								   echo '<tr>
											...
											<td>'.$linha['sexo'].'</td>
											<td>
											 <a title="Enviar" onclick=niver('.$linha['codcli'].')  href="#" class="btn btn-sm btn-danger"><i class="fa fa-check" style="color: white;"></i></a>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="aniversario.php"><i class="fa fa-calendar"></i> <span>Cartas de Aniversário</span><div class="clearfix"></div></a></li>
