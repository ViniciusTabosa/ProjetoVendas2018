...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../principal.php">Principal</a><i class="fa fa-angle-right"></i>Usuario <i class="fa fa-angle-right"></i> Busca de Produtos<i class="fa fa-angle-right"></i>Alteração de Produto</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">

  <div class="grid-form1">
  	       <center><h3><i class="fa fa-user"></i> Alteração de Produto </h3></center>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['codPro']?>" name="codPro" id="codPro" type="text" class="form-control1" readonly="true">
										</div>
									</div>
								</div>
							
								<div class="form-group">
										<label class="col-md-2 control-label">Descriçao:</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa-product-hunt"></i>
											</span>
												<input  value="<?php echo $linha['descricao']?>" name="descricao" id="descricao" type="text" class="form-control1">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['unidade']?>" name="unidade" id="unidade" type="text" class="form-control1">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['precoCusto']?>" name="precoCusto" id="precoCusto" type="text" class="form-control1">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['precoVenda']?>" name="precoVenda" id="precoVenda" type="text" class="form-control1">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['estoque']?>" name="estoque" id="estoque" type="text" class="form-control1">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input  value="<?php echo $linha['estoque']?>" name="codFornecedor" id="codFornecedor" type="text" class="form-control1">
										</div>
									</div>
								</div>
								<br>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											<button type="submit" onclick="alterar" class="btn-primary btn">Alterar</button>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li><a href="buscapro.php"><i class="fa fa-undo"></i> <span>Voltar</span><div class="clearfix"></div></a></li>
									</ul>
								</div>
							  </div>
							  <div class="clearfix"></div>		
