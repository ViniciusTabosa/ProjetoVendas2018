...
<!--heder end here-->
						<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i>Relatório de Compras</li>
						</ol>
							...
							if($consulta->num_rows > 0){
							   while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
								   echo '<tr>
											...
											<td>'.$linha['email'].'</td>
											<td>
											 <a title="Alterar" onclick=alterar('.$linha['codUsu'].')    href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit" style="color: white;"></i></a>
											 <a title="Excluir" onclick=deletar('.$linha['codUsu'].')  href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash" style="color: white;"></i></a>
							...
							if($consulta->num_rows > 0){
							   while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
								   echo '<tr>
											...
											<td>
											 <a title="Alterar" onclick=alterar('.$linha['codPro'].')    href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit" style="color: white;"></i></a>
											 <a title="Excluir" onclick=deletar('.$linha['codPro'].')  href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash" style="color: white;"></i></a>
									...
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Relatório</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 <ul id="menu-academico-sub" >
											<li id="menu-academico-boletim" ><a href="../vendas/relatorioven.php">Vendas</a></li>
											
										  </ul>
										</li>
										<li><a href="../../principal.php"><i class="fa fa-undo"></i> <span>Voltar</span><div class="clearfix"></div></a></li>
									</ul>
								</div>
							  </div>
							  <div class="clearfix"></div>		
