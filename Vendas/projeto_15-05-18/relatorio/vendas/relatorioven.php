...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i>Relatório de Vendas</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<div class="bs-component mb20">
						<button onclick=""type="button" class="btn active btn-dark btn-block">Gerar relatório de Vendas</button>
					</div>
					<!--	
									...
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Relatório</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 <ul id="menu-academico-sub" >
											<li id="menu-academico-boletim" ><a href="../compras/relatoriocom.php">Compras</a></li>
