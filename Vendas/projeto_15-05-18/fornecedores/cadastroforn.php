...
<script>
  function validar(){
     if(confirm("Deseja cadastrar novo fornecedor?")){
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../principal.php">Principal</a><i class="fa fa-angle-right"></i>Fornecedor <i class="fa fa-angle-right"></i> Busca de Fornecedor<i class="fa fa-angle-right"></i>Cadastro de Fornecedor</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       ...
  	       <center><h3><i class="fa fa-user"></i> Cadastro de Fornecedor </h3></center>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="nome" id="nome" type="text" class="form-control1" placeholder="Nome do Fornecedor">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="cpf" id="cpf" type="text" class="form-control1" placeholder="Cnpj">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="endereco" id="endereco" type="text" class="form-control1" placeholder="Endereço">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="fone" id="fone" type="number" class="form-control1" placeholder="Contato">
										</div>
									</div>
								</div>
