...
<script>
   ...
   function alterar(cod){
	   if(confirm('Deseja alterar esse item?')){
		  location.href='alteraforn.php?cod='+cod; 
	   }
   }   
</script>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i>Fornecedores<i class="fa fa-angle-right"></i>Busca de Fornecedores</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<a href="cadastroforn.php" class="btn btn-md btn-success pull-right"><i class="fa fa-plus"></i>&nbsp;Novo</a></br>
					  ...
					  ?>
						 ...
						 <div class="input-group text-left">
							    <input class="form-control" type="text" name="texto" placeholder="Digite o Nome do Fornecedores">
							...
							if($consulta->num_rows > 0){
							   while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
								   echo '<tr>
											...
											<td>'.$linha['fone'].'</td>
											<td>
											 <a title="Alterar" onclick=alterar('.$linha['codFornecedores'].')    href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit" style="color: white;"></i></a>
											 <a title="Excluir" onclick=deletar('.$linha['codFornecedores'].')  href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash" style="color: white;"></i></a>
