...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../principal.php">Principal</a><i class="fa fa-angle-right"></i>Cliente<i class="fa fa-angle-right"></i> Busca de Clientes <i class="fa fa-angle-right"></i> Cadastro de Clientes</li>
    </ol>
		<!--grid-->
 	<div class="grid-form">
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="nome" id="nome" type="text" class="form-control1" placeholder="Seu Nome">
									 	</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="datanasc" id="datanasc" type="date" class="form-control1" placeholder="Data de Nascimento">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="telefone" id="telefone" type="text" class="form-control1" placeholder="Seu Telefone">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="rg" id="rg" type="text" class="form-control1" placeholder="RG">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="cpf" id="cpf" type="text" class="form-control1" placeholder="CPF">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input name="endereco" id="endereco" type="text" class="form-control1" placeholder="Seu Endereço">
										</div>
									</div>
								</div>
