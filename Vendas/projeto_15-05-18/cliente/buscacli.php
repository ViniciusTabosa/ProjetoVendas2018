...
<script>
   ...
   function alterar(cod){
	   if(confirm('Deseja alterar esse item?')){
		  location.href='alteracli.php?cod='+cod; 
	   }
   }   
</script>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="principal.php">Principal</a><i class="fa fa-angle-right"></i> Cliente<i class="fa fa-angle-right"></i> Busca de Clientes</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<a href="cadastrocli.php" class="btn btn-md btn-success pull-right"><i class="fa fa-plus"></i>&nbsp;Novo</a></br>
					  ...
					  ?>
						 ...
						 <div class="input-group text-left">
							    <input class="form-control" type="text" name="texto" placeholder="Digite o nome do cliente">
					    ...
					    if(isset($_POST['texto'])){
							...
							//criando a consulta
							$sql = "select *, date_format(nascimento,'%d/%m/%Y') as nascimento2 from tbcliente
							        where nome like
									'%$texto%'";
							...
							if($consulta->num_rows > 0){
							   while($linha=$consulta->fetch_array(MYSQLI_ASSOC)){
								   echo '<tr>
											<td>'.$linha['nome'].'</td>
											<td>'.$linha['nascimento2'].'</td>
											<td>'.$linha['fone'].'</td>
											<td>'.$linha['rg'].'</td>
											<td>'.$linha['cpf'].'</td>
											<td>'.$linha['endereco'].'</td>
											<td>
											 <a title="Alterar" onclick=alterar('.$linha['codCli'].') href="#" class="btn btn-sm btn-primary"><i class="fa fa-edit" style="color: white;"></i></a>
											 <a title="Excluir" onclick=deletar('.$linha['codCli'].') href="#" class="btn btn-sm btn-danger"><i class="fa fa-trash" style="color: white;"></i></a>
