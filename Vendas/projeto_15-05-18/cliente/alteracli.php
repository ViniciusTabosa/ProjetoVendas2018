...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../principal.php">Principal</a><i class="fa fa-angle-right"></i>Cliente<i class="fa fa-angle-right"></i> Busca de Clientes <i class="fa fa-angle-right"></i> Alteração de Cliente</li>
    </ol>
		<!--grid-->
 	<div class="grid-form">

  <div class="grid-form1">
  	       <center><h3><i class="fa fa-user"></i> Alteração de Cliente</h3></center>
		   
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" method="POST" action="alterar.php" onsubmit=" return validar();"><br>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['codCli']?>" name="codCli" id="codCli" type="text" class="form-control1" readonly="true">
									 	</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['nome']?>" name="nome" id="nome" type="text" class="form-control1" placeholder="Seu Nome">
									 	</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['nascimento']?>" name="nascimento" id="nascimento" type="date" class="form-control1" placeholder="Data de Nascimento">
										</div>
									</div>
								</div>
							
								<div class="form-group">
										<label class="col-md-2 control-label">Seu Telefone:</label>
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												<i class="fa fa-phone"></i>
											</span>
												<input value="<?php echo $linha['fone']?>" name="telefone" id="telefone" type="text" class="form-control1" placeholder="Seu Telefone">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['rg']?>" name="rg" id="rg" type="text" class="form-control1" placeholder="RG">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['cpf']?>" name="cpf" id="cpf" type="text" class="form-control1" placeholder="CPF">
										</div>
									</div>
								</div>
									...
									<div class="col-md-8">
										<div class="input-group input-icon right">
											<span class="input-group-addon">
												...
												<input value="<?php echo $linha['endereco']?>" name="endereco" id="endereco" type="text" class="form-control1" placeholder="Seu Endereço">
										</div>
									</div>
								</div>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											...
											<a href="buscacli.php" class="btn-default btn">Cancelar</a>
										</div>
									</div>
								</div>
